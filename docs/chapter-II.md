        ...
        <tbody>
            ...
            <tr>
                <tr>
                    ...
                    <td colspan="2">EasyFood</td>
                    <td colspan="2"><img src="/assets/img/chapter-II/Competidor-1.png" style="width: 60px; height: auto;"><br>Manzana Verde</td>
                    <td colspan="2"><img src="/assets/img/chapter-II/Competidor-2.png" style="width: 60px; height: auto;"><br>Lifesum</td>
...
#### Guia de preguntas para los usuarios del segmento objetivo Restaurantes:
...
<p style="text-align: justify;">A continuación, se presentará un resumen de toda la información recaudada de las entrevistas realizadas a los segmentos objetivos. Además, cada entrevista contará una captura de pantalla como evidencia y el intervalo de tiempo de duración que tienen en el video realizado, para que sea más sencillo ubicarlos.</p> 
...
**Entrevista 2:** Wilber Santos Córdova Jimenez 

![Restaurant-Segment-Interview-1](/assets/img/chapter-II/Restaurant-Segment-Interview-1.png)

**Datos del Entrevistado:**

* **Nombre:** Wilber Santos Córdova Jimenez 
* **Edad:** 54
* **Ocupación:** Cocinero
* **Ubicación de la Empresa:** Miraflores 
* **Duración de la entrevista:** [00:30:53 - 00:35:43]
  
* **Resumen de la Entrevista:**
<p style="text-align:justify">En la entrevista realizada a Wilber, él trabaja en un restaurante como cocinero. Nos menciona que en su trabajo normalmente llegan a atender de 150 a 180 clientes. La atención que brinda en el restaurante se basa en que el mozo se acerca a la mesa del cliente, el mozo recepciona el pedido y utiliza una aplicación para enviar el pedido a una maquina que esta en la zona de cocina para que los cocineros puedan preparar los platillos según la orden de llega de cada cliente, para el caso de delivery, ellos brindan un número de teléfono en el que el cliente realiza su pedido y cuando ya esté listo su pedido, el cliente lo recoge. También nos mencionan que ellos brindan publicidad sobre su restaurante, mediante redes sociales como Facebook o Whatsapp. Para finalizar, si una empresa desea ordenar una alta cantidad de menús, ellos priorizan tener a toda disponibilidad los productos que van a emplear para los menús solicitados y poder tenerlos listo para la reserva previa que ha realizado el cliente. 
...
* El 66,6% de los entrevistados recibe menos clientes de los esperados, mientras que el 33,3% restante está satisfecho con los clientes que recibe.

* El 66,6% de los entrevistados recibe pedidos para recogerlos en su local, mientras que el 33,3% restante hace servicio de delivery.
...
* El 100% de los entrevistados no usa un programa o software para hacer el control de sus inventarios.

* El 66,6% de los entrevistados llevan el control de asistencia de sus empleados.

* El 100% de los entrevistados realizan publicidad de su negocio para atraer a más clientes.

* El 66,6% de los entrevistados relatan que no les fue fácil lidiar con una cantidad alta de pedidos de manera repentina, mientras que el 33,3% restante indica que no le resultó difícil cumplir con una alta cantidad de órdenes. 
